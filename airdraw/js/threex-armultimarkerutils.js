...
ARjs.MarkersAreaUtils.createDefaultMultiMarkerFile = function(trackingBackend){
	...
	if( trackingBackend === 'artoolkit' ){
		...
		file.subMarkersControls[0].parameters.patternUrl = absoluteBaseURL + 'marcadores/pattern-letterA.patt'
...
ARjs.MarkersAreaUtils.createDefaultMarkersControlsParameters = function(trackingBackend){
	...
	if( trackingBackend === 'artoolkit' ){
		...
		var markersControlsParameters = [
			{
				type : 'pattern',
				patternUrl : absoluteBaseURL + 'marcadores/pattern-letterA.patt',
			},
			{
				type : 'pattern',
				patternUrl : absoluteBaseURL + 'marcadores/pattern-letterB.patt',
			},{
				type : 'pattern',
				patternUrl : absoluteBaseURL + 'marcadores/pattern-letterC.patt',
			},{
				type : 'pattern',
				patternUrl : absoluteBaseURL + 'marcadores/pattern-letterD.patt',
			},{
				type : 'pattern',
				patternUrl : absoluteBaseURL + 'marcadores/pattern-letterF.patt',
			},
		]		
	}else if( trackingBackend === 'aruco' ){
		var markersControlsParameters = [
...
ARjs.MarkersAreaUtils.buildMarkersAreaFileFromResolution = function(trackingBackend, resolutionW, resolutionH){
	...
	function layout2MarkerParametersArtoolkit(parameters, layout){
		...
		var layout2PatternUrl = {
			'center' : convertRelativeUrlToAbsolute(absoluteBaseURL + 'marcadores/pattern-letterA.patt'),
			'topleft' : convertRelativeUrlToAbsolute(absoluteBaseURL + 'marcadores/pattern-letterB.patt'),
			'topright' : convertRelativeUrlToAbsolute(absoluteBaseURL + 'marcadores/pattern-letterC.patt'),
			'bottomleft' : convertRelativeUrlToAbsolute(absoluteBaseURL + 'marcadores/pattern-letterD.patt'),
			'bottomright' : convertRelativeUrlToAbsolute(absoluteBaseURL + 'marcadores/pattern-letterF.patt'),
		}
