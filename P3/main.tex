...
\begin{itemize}
    ...
    \begin{figure}[H]
    \centering
        \includegraphics[width=0.8\textwidth]{recomendar.png}
        \caption{Recomendación de los clientes}
    \end{figure}
    
    \item Por último, preguntamos sobre lo novedosa que les parece la aplicación, obteniendo unos resultados, quizá no tan optimistas como esperábamos, pero buenos, puesto que el 62\% de los encuestados la consideran novedosa.
    
    \begin{figure}[H]
    \centering
        \includegraphics[width=0.8\textwidth]{novedad.png}
        \caption{Novedad que presenta la aplicación}
    \end{figure}
\end{itemize}

\subsection{Conclusiones}

Como comprobamos con las encuestas, nuestro modelo de negocio parece que puede tener éxito y somos optimistas ante el futuro que puede tener en el mercado.
